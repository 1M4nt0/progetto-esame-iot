...
void DeviceDisplay::drawTwoToScreen(String message1, String message2)
{
    ...
    this->_display->drawString(this->_display->getWidth() / 2, (this->_display->getHeight() / 4) * 3, message2);
    this->_display->display();
}
...
void DeviceDisplay::drawDashboard(int player, int points)
{
    ...
    this->_display->drawString(this->_display->getWidth() / 2, (this->_display->getHeight() / 4) * 3, "Punti: " + String(points));
    this->_display->display();
}